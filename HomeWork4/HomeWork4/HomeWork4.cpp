...
void Raz(string t, int ur, int n, int k)
{
	...
	if (ur > k)
	{
		...
		if ((one <= 1 && two <= 1 && three <= 1 && four <= 1 && five <= 1 && six == 3 && seven == 2) ||			                    // Задание 1 Ввод : 7
			...
			//	if ((p <= 1 && t <= 1 && y <= 1 && o <= 1 && u <= 1 && yy == 2 && uu == 2 && gg == 3) ||			// Задание 2 Ввод : 9
		//	(p <= 1 && t <= 1 && y <= 1 && o <= 1 && u == 2 && yy == 2 && uu == 3 && gg <= 2) ||
		//	(p <= 1 && t <= 1 && y <= 1 && o == 2 && u == 2 && yy == 3 && uu <= 1 && gg <= 2) ||
		//	(p <= 1 && t <= 1 && y == 2 && o == 2 && u == 3 && yy <= 1 && uu <= 1 && gg <= 2) ||
		//	(p <= 1 && t == 2 && y == 2 && o == 3 && u <= 1 && yy <= 1 && uu <= 1 && gg <= 2) ||
		//	(p == 2 && t == 2 && y == 3 && o <= 1 && u <= 1 && yy <= 1 && uu <= 1 && gg <= 2))
		{
			for (int i = 0; i < k; i++)
			{
				if (t[i] == '1')
